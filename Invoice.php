...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://d3pgswpng8id0l.cloudfront.net/sitestatic/qualaroo/qualaroo-theme.css">
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="control-group vendor">
                                                                    ...
                                                                    <div class="controls">
                                                                        ...
                                                                        <div class="">
                                                                            ...
                                                                            </div><select id="c454_vendor" name="vendor"
                                                                                class="input-medium select2-offscreen"
                                                                                data-placeholder="Choose" tabindex="-1">
                                                                                <option></option>
                                                                                <option value="c451">Integrea</option>
                                                                            </select>
                                                                        </div>
                                                                ...
                                                                <div class="control-group bill_currency">
                                                                    ...
                                                                    <div class="controls">
                                                                        ...
                                                                        <div class="">
                                                                            <div class="select2-container input-medium"
                                                                                id="s2id_c454_bill_currency"><a
                                                                                    href="javascript:void(0)"
                                                                                    onclick="return false;"
                                                                                    class="select2-choice"
                                                                                    tabindex="-1"> <span>USD - U.S.
                                                                                        dollar</span><abbr
                                                                                        class="select2-search-choice-close"
                                                                                        style="display:none;"></abbr>
                                                                                    <div><b></b></div>
                                                                            ...
                                                                            </div><select id="c454_bill_currency"
                                                                                name="bill_currency"
                                                                                class="input-medium select2-offscreen"
                                                                                data-placeholder="Choose" tabindex="-1">
                                                                                <option value="c379">AED - UAE dirham
                                                                                </option>
                                                                                <option value="c2">AFN - Afghani
                                                                                </option>
                                                                                <option value="c6">ALL - Lek</option>
                                                                                <option value="c21">AMD - Armenian dram
                                                                                </option>
                                                                                <option value="c102">ANG - Netherlands
                                                                                    Antillean Guilder</option>
                                                                                <option value="c13">AOA - Kwanza
                                                                                </option>
                                                                                <option value="c19">ARS - Argentinian
                                                                                    peso</option>
                                                                                <option value="c25">AUD - Australian
                                                                                    dollar</option>
                                                                                <option value="c23">AWG - Aruban Guilder
                                                                                </option>
                                                                                <option value="c28">AZN - New Manat
                                                                                </option>
                                                                                <option value="c52">BAM - Convertible
                                                                                    Marks</option>
                                                                                <option value="c36">BBD - Barbados
                                                                                    dollar</option>
                                                                                <option value="c34">BDT - Taka</option>
                                                                                <option value="c63">BGN - Lev</option>
                                                                                <option value="c32">BHD - Bahraini dinar
                                                                                </option>
                                                                                <option value="c66">BIF - Burundi franc
                                                                                </option>
                                                                                <option value="c45">BMD - Bermuda dollar
                                                                                </option>
                                                                                <option value="c61">BND - Brunei dollar
                                                                                </option>
                                                                                <option value="c49">BOB - Boliviano
                                                                                </option>
                                                                                <option value="c58">BRL - Real</option>
                                                                                <option value="c30">BSD - Bahamian
                                                                                    dollar</option>
                                                                                <option value="c47">BTN - Ngultrum
                                                                                </option>
                                                                                <option value="c54">BWP - Pula</option>
                                                                                <option value="c38">BYR - Belarussian
                                                                                    rouble</option>
                                                                                <option value="c41">BZD - Belize dollar
                                                                                </option>
                                                                                <option value="c72">CAD - Canadian
                                                                                    dollar</option>
                                                                                <option value="c91">CDF - Franc
                                                                                    congolais</option>
                                                                                <option value="c216">CHF - Swiss franc
                                                                                </option>
                                                                                <option value="c80">CLP - Chilean peso
                                                                                </option>
                                                                                <option value="c82">CNY - Ren-Min-Bi
                                                                                    yuan</option>
                                                                                <option value="c86">COP - Colombian peso
                                                                                </option>
                                                                                <option value="c95">CRC - Costa Rican
                                                                                    colon</option>
                                                                                <option value="c100">CUP - Cuban peso
                                                                                </option>
                                                                                <option value="c74">CVE - Cape Verde
                                                                                    escudo</option>
                                                                                <option value="c105">CZK - Czech koruna
                                                                                </option>
                                                                                <option value="c109">DJF - Djibouti
                                                                                    franc</option>
                                                                                <option value="c107">DKK - Danish krone
                                                                                </option>
                                                                                <option value="c112">DOP - Dominican
                                                                                    peso</option>
                                                                                <option value="c8">DZD - Algerian dinar
                                                                                </option>
                                                                                <option value="c401">EEK - Estonian
                                                                                    kroon</option>
                                                                                <option value="c115">EGP - Egyptian
                                                                                    pound</option>
                                                                                <option value="c119">ERN - Nakfa
                                                                                </option>
                                                                                <option value="c124">ETB - Ethiopian
                                                                                    birr</option>
                                                                                <option value="c4">EUR - Euro</option>
                                                                                <option value="c129">FJD - Fiji dollar
                                                                                </option>
                                                                                <option value="c126">FKP - Falkland
                                                                                    Islands (Malvinas) Pound</option>
                                                                                <option value="c154">GBP - Pound
                                                                                    sterling</option>
                                                                                <option value="c140">GEL - Lari</option>
                                                                                <option value="c143">GHS - Ghana Cedi
                                                                                </option>
                                                                                <option value="c145">GIP - Gibraltar
                                                                                    pound</option>
                                                                                <option value="c138">GMD - Dalasi
                                                                                </option>
                                                                                <option value="c156">GNF - Guinean franc
                                                                                </option>
                                                                                <option value="c152">GTQ - Quetzal
                                                                                </option>
                                                                                <option value="c402">GWP - Guinean
                                                                                    bissau Peso</option>
                                                                                <option value="c159">GYD - Guyana dollar
                                                                                </option>
                                                                                <option value="c167">HKD - Hong Kong
                                                                                    dollar</option>
                                                                                <option value="c165">HNL - Lempira
                                                                                </option>
                                                                                <option value="c98">HRK - Kuna</option>
                                                                                <option value="c161">HTG - Haitian
                                                                                    gourde</option>
                                                                                <option value="c169">HUF - Forint
                                                                                </option>
                                                                                <option value="c175">IDR - Rupiah
                                                                                </option>
                                                                                <option value="c183">ILS - New Israeli
                                                                                    sheqel</option>
                                                                                <option value="c173">INR - Indian rupee
                                                                                </option>
                                                                                <option value="c179">IQD - Iraqi dinar
                                                                                </option>
                                                                                <option value="c177">IRR - Iranian rial
                                                                                </option>
                                                                                <option value="c171">ISK - Icelandic
                                                                                    Krona</option>
                                                                                <option value="c186">JMD - Jamaican
                                                                                    dollar</option>
                                                                                <option value="c191">JOD - Jordanian
                                                                                    dinar</option>
                                                                                <option value="c188">JPY - Yen</option>
                                                                                <option value="c195">KES - Kenyan
                                                                                    shilling</option>
                                                                                <option value="c203">KGS - Kyrgyz Som
                                                                                </option>
                                                                                <option value="c68">KHR - Riel</option>
                                                                                <option value="c88">KMF - Comoro franc
                                                                                </option>
                                                                                <option value="c198">KRW - Won</option>
                                                                                <option value="c201">KWD - Kuwaiti dinar
                                                                                </option>
                                                                                <option value="c76">KYD - Cayman Islands
                                                                                    dollar</option>
                                                                                <option value="c193">KZT - Tenge
                                                                                </option>
                                                                                <option value="c205">LAK - Kip</option>
                                                                                <option value="c208">LBP - Lebanese
                                                                                    pound</option>
                                                                                <option value="c340">LKR - Sri Lankan
                                                                                    rupee</option>
                                                                                <option value="c212">LRD - Liberian
                                                                                    dollar</option>
                                                                                <option value="c210">LSL - Loti</option>
                                                                                <option value="c403">LTL - Lithuanian
                                                                                    litus</option>
                                                                                <option value="c404">LVL - Latvian lats
                                                                                </option>
                                                                                <option value="c214">LYD - Libyan dinar
                                                                                </option>
                                                                                <option value="c249">MAD - Moroccan
                                                                                    dirham</option>
                                                                                <option value="c242">MDL - Moldovan leu
                                                                                </option>
                                                                                <option value="c222">MGA - Malagasy
                                                                                    Ariary</option>
                                                                                <option value="c270">MKD - Denar
                                                                                </option>
                                                                                <option value="c253">MMK - Kyat</option>
                                                                                <option value="c245">MNT - Tugrik
                                                                                </option>
                                                                                <option value="c220">MOP - Pataca
                                                                                </option>
                                                                                <option value="c405">MRO - Ouguiya
                                                                                </option>
                                                                                <option value="c234">MRU - Ouguiya
                                                                                </option>
                                                                                <option value="c236">MUR - Mauritian
                                                                                    rupee</option>
                                                                                <option value="c228">MVR - Rufiyaa
                                                                                </option>
                                                                                <option value="c224">MWK - Kwacha
                                                                                </option>
                                                                                <option value="c239">MXN - Mexican peso
                                                                                </option>
                                                                                <option value="c226">MYR - Malaysian
                                                                                    ringgit</option>
                                                                                <option value="c251">MZN - Metical
                                                                                </option>
                                                                                <option value="c255">NAD - Namibian
                                                                                    dollar</option>
                                                                                <option value="c266">NGN - Naira
                                                                                </option>
                                                                                <option value="c263">NIO - Cordoba Oro
                                                                                </option>
                                                                                <option value="c56">NOK - Norwegian
                                                                                    krone</option>
                                                                                <option value="c258">NPR - Nepalese
                                                                                    rupee</option>
                                                                                <option value="c93">NZD - New Zealand
                                                                                    dollar</option>
                                                                                <option value="c274">OMR - Omani rial
                                                                                </option>
                                                                                <option value="c279">PAB - Balboa
                                                                                </option>
                                                                                <option value="c285">PEN - Nuevo Sol
                                                                                </option>
                                                                                <option value="c281">PGK - Kina</option>
                                                                                <option value="c287">PHP - Philippine
                                                                                    peso</option>
                                                                                <option value="c276">PKR - Pakistani
                                                                                    rupee</option>
                                                                                <option value="c290">PLN - Zloty
                                                                                </option>
                                                                                <option value="c283">PYG - Guarani
                                                                                </option>
                                                                                <option value="c294">QAR - Qatari riyal
                                                                                </option>
                                                                                <option value="c297">RON - New Leu
                                                                                </option>
                                                                                <option value="c319">RSD - Serbian Dinar
                                                                                </option>
                                                                                <option value="c299">RUB - Russian
                                                                                    rouble</option>
                                                                                <option value="c301">RWF - Rwanda franc
                                                                                </option>
                                                                                <option value="c316">SAR - Saudi riyal
                                                                                </option>
                                                                                <option value="c330">SBD - Solomon
                                                                                    Islands Dollar</option>
                                                                                <option value="c321">SCR - Seychelles
                                                                                    rupee</option>
                                                                                <option value="c337">SDG - Sudanese
                                                                                    Pound</option>
                                                                                <option value="c347">SEK - Swedish Krona
                                                                                </option>
                                                                                <option value="c325">SGD - Singapore
                                                                                    dollar</option>
                                                                                <option value="c304">SHP - Saint Helena
                                                                                    Pound</option>
                                                                                <option value="c323">SLL - Leone
                                                                                </option>
                                                                                <option value="c332">SOS - Somali
                                                                                    shilling</option>
                                                                                <option value="c344">SRD - Surinam
                                                                                    dollar</option>
                                                                                <option value="c406">SSP - South
                                                                                    Sudanese pound</option>
                                                                                <option value="c314">STD - Dobra
                                                                                </option>
                                                                                <option value="c407">SVC - El Salvador
                                                                                    colon</option>
                                                                                <option value="c350">SYP - Syrian pound
                                                                                </option>
                                                                                <option value="c122">SZL - Lilangeni
                                                                                </option>
                                                                                <option value="c358">THB - Baht</option>
                                                                                <option value="c354">TJS - Somoni
                                                                                </option>
                                                                                <option value="c371">TMM - Manat
                                                                                </option>
                                                                                <option value="c367">TND - Tunisian
                                                                                    dinar</option>
                                                                                <option value="c363">TOP - Pa'anga
                                                                                </option>
                                                                                <option value="c369">TRY - Turkish Lira
                                                                                </option>
                                                                                <option value="c365">TTD - Trinidad and
                                                                                    Tobago dollar</option>
                                                                                <option value="c352">TWD - Taiwan New
                                                                                    Dollar</option>
                                                                                <option value="c356">TZS - Tanzanian
                                                                                    shilling</option>
                                                                                <option value="c377">UAH - Hryvnia
                                                                                </option>
                                                                                <option value="c375">UGX - Ugandan
                                                                                    shilling</option>
                                                                                <option value="c10">USD - U.S. dollar
                                                                                </option>
                                                                                <option value="c384">UYU - Uruguayo peso
                                                                                </option>
                                                                                <option value="c408">UZS - Uzbekistan
                                                                                    sum</option>
                                                                                <option value="c389">VEF - Bolivar
                                                                                    Fuerte</option>
                                                                                <option value="c391">VND - Dong</option>
                                                                                <option value="c387">VUV - Vatu</option>
                                                                                <option value="c311">WST - Samoan Tala
                                                                                </option>
                                                                                <option value="c43">XAF - CFA Franc -
                                                                                    BEAC</option>
                                                                                <option value="c15">XCD - Eastern
                                                                                    Caribbean dollar</option>
                                                                                <option value="c70">XOF - CFA franc -
                                                                                    BCEAO</option>
                                                                                <option value="c134">XPF - Comptoirs
                                                                                    Francais du Pacifique Francs
                                                                                </option>
                                                                                <option value="c397">YER - Yemeni rial
                                                                                </option>
                                                                                <option value="c334">ZAR - Rand</option>
                                                                                <option value="c409">ZMK - Kwacha
                                                                                </option>
                                                                                <option value="c410">ZMW - Kwacha
                                                                                </option>
                                                                                <option value="c400">ZWD - Zimbabwean
                                                                                    dollar</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="help-block"></div>
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="control-group bill_date">
                                                                    ...
                                                                    <div class="controls">
                                                                        <div class="small-text control-error-message"><b
                                                                                class="bbf-tmp-errors"></b></div>
                                                                        <div class="">
                                                                            <div id="c454_bill_date"
                                                                                class="bbf-wui-date input-medium"
                                                                                name="bill_date"><span
                                                                                    class="wdp-input-wrap"><input
                                                                                        type="text" class="input-small"
                                                                                        name="bill_date"></span></div>
                                                                        </div>
                                                                        <div class="help-block"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="control-group due_date">
                                                                    ...
                                                                    <div class="controls">
                                                                        <div class="small-text control-error-message"><b
                                                                                class="bbf-tmp-errors"></b></div>
                                                                        <div class="">
                                                                            <div id="c454_due_date"
                                                                                class="bbf-wui-date input-medium"
                                                                                name="due_date"><span
                                                                                    class="wdp-input-wrap"><input
                                                                                        type="text" class="input-small"
                                                                                        name="due_date"></span></div>
                                                                            <span
                                                                                class="small-text muted js-invoice-payment-terms"></span>
                                                                        </div>
                                                                        <div class="help-block"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="control-group po_so_number">
                                                                    ...
                                                                    <div class="controls">
                                                                        <div class="small-text control-error-message"><b
                                                                                class="bbf-tmp-errors"></b></div>
                                                                        <div class=""><input id="c454_po_so_number"
                                                                                name="po_so_number" class="input-medium"
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="control-group memo">
                                                                    ...
                                                                    <div class="controls">
                                                                        <div class="small-text control-error-message"><b
                                                                                class="bbf-tmp-errors"></b></div>
                                                                        <div class=""><textarea id="c454_memo"
                                                                                name="memo" class="input-medium"
