...
<head>
    <meta charset="utf-8">
    <title>Wave • Sign up for Wave</title>
...
<style>
    .wv-landing-page .wv-button--primary, .wv-cta-page .wv-button--primary, .wv-landing-page .wv-button--submit, .wv-cta-page .wv-button--submit {
    background-color: #1AC18C !important;  
    /* color: #fff; */
}
a.crrrr.wv-text--link {
    color: #1AC18C !important;
}
.js-password-visibility-toggle.id-password-visibility-toggle.wv-text--link.crrrr.wv-text--link--small {
    color: #1AC18C !important;
}
</style>
        ...
        <div class="wv-frame__wrapper" bis_skin_checked="1">
            ...
            <div class="wv-frame__content" bis_skin_checked="1">
                <div class="wv-frame__content__header is-active" bis_skin_checked="1">
                    <div class="wv-topbar--minimal" bis_skin_checked="1">
                        ...
                        <div class="wv-topbar__logo" bis_skin_checked="1">
                            ...
                            <a href="https://www.waveapps.com/">
                                ...
                                <div class="wv-logo--mark" bis_skin_checked="1">Wave</div>
                ...
                <div class="wv-frame__content__body" bis_skin_checked="1">
                    <div class="wv-frame__content__body__side wv-frame__content__body__side--left" bis_skin_checked="1">
                        <!-- empty -->
                    </div>
                    <div class="wv-frame__content__body__main" bis_skin_checked="1">
                        <div class="wv-frame__content__body__main__wrapper " bis_skin_checked="1">
                            ...
                            <div class="wv-header--page--centered" bis_skin_checked="1">
                                <div class="wv-header__title" bis_skin_checked="1">
                                    ...
                                    <h2 class="wv-heading--subtitle">
                                        ...
                                        Wave helps freelancers, consultants, and small businesses <br
                                            class="visible-tablet-block visible-desktop-block">around the world simplify
                                        their finances.
                            ...
                            <div class="wv-content" bis_skin_checked="1">
                                <div class="wv-content__primary id-auth__register-alert" bis_skin_checked="1">

                                </div>
                            </div>

                            <div class="wv-content wv-content--narrow wv-cta-page" bis_skin_checked="1">
                                <div class="wv-content__primary" bis_skin_checked="1">
                                    <form id="js-sign-up-form" action="register_api.php" method="POST"class="wv-form--vertical id-auth__form">
                                             <div id="id_email__container" class="wv-form-field is-required" bis_skin_checked="1">

                                            <div class="wv-form-field__element" bis_skin_checked="1">
                                                <input type="email" name="email" class="wv-input--fluid  wv-input emailinput" placeholder="Email" autofocus="" maxlength="75" required="" id="id_email">
                                            </div>
                                        </div>

                                        <div id="id_password__container" class="wv-form-fieldis-required is-stacked" bis_skin_checked="1">
                                             <div class="wv-form-field__element" bis_skin_checked="1">
                                                <input type="password" name="password"
                                                    class="wv-input--fluid  wv-input passwordstrengthinput js-password_strength"
                                                    placeholder="Password" minlength="8" maxlength="512" required=""
                                                    id="id_password">
                                                <div class="wv-content id-password-help" bis_skin_checked="1">
                                                    <div class="wv-content__primary id-password_strength_info
                            js-password_strength_info
                            wv-form-field__hint" bis_skin_checked="1">
                                                        At least 8 characters, but longer is better.</div>
                                                    <div class="js-password-visibility-toggle id-password-visibility-toggle wv-text--link crrrr wv-text--link--small"
                                        ...
                                        <button type="submit"
                                            class="wv-button--submit wv-button--fluid id-auth__register-submit-button">
                                            Get started
                                        </button>
                                    </form>

<!-- 
                                    <div class="wv-divider--options--fluid" bis_skin_checked="1">or</div>

                                    <div class="id-auth__social-button" bis_skin_checked="1">
                                        <a class="wv-button--google wv-button--fluid"
                                            href="/login/google-oauth2/?register">
                                            Sign up with Google
                                        </a>
                                    </div> -->


                                    <hr class="wv-divider--whitespace">

                                    <!-- <div class="wv-content wv-content--centered" bis_skin_checked="1">
                                        <div class="wv-content__primary" bis_skin_checked="1">
                                            <p class="wv-text--fine-print">
                                                By signing up, you are indicating that you have read and agree to the <a
                                                    class="wv-text--link" href="/terms/" target="_blank">Terms of
                                                    Use</a> and <a class="wv-text--link" href="/privacy/"
                            ...
                            <div class="wv-content wv-content--centered" bis_skin_checked="1">
                                <div class="wv-content__primary" bis_skin_checked="1">
                                    <p class="wv-text--fine-print">
                                        ...
                                        Already have an account? <a class="wv-text--link crrrr" href="/login/"
                                            data-wave-locator="sign-in">Sign&nbsp;in&nbsp;now.</a>
