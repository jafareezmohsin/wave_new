...
<head>
    ...
    <title>Wave • Derman • Customers</title>
    <style type="text/css" data-tippy-stylesheet="">

button.wv-button--secondary.fs-exclude.qx4zTqj9tVqM1yRSJy3t{
    ...
    .wv-button--primary {
        ...
        background-color: #00d08a !important;
    }
    ...
    .wv-button--primary:focus:not(.is-disabled) {
        background-color: #0caf78 !important;
    }
    ...
    .wv-button--google {
        ...
        border: 1px solid #00d08a !important;
    }
...
<body
    ...
    <div id="Content" style="height:100%" bis_skin_checked="1">
        <div class="wv-frame wv-frame--app zzzzzz pg-customers_add" style="" bis_skin_checked="1">
                            ...
                            <div class="wv-frame__content__body__main__wrapper" data-testid="frame-wrapper"
                                ...
                                <div class="wv-header--page" bis_skin_checked="1">
                                    <div class="wv-header__title" bis_skin_checked="1">
                                        <h1 class="wv-heading--title fs-exclude">New customer</h1>
                                    </div>
                                </div>
                                <div class="wv-divider" bis_skin_checked="1"></div>
                                <div class="wv-form--horizontal JnC23BolYXGvimZNnLgc" bis_skin_checked="1">
                                    <fieldset class="wv-form-fieldset">
                                        <legend class="wv-form-legend">Basic information</legend>
                                        <!-- <div class="wv-form-field is-required fs-exclude" bis_skin_checked="1"><label
                                                class="wv-form-field__label">
                                                <div class="wv-form-field__label__text" bis_skin_checked="1">Customer
                                                </div>
                                            </label>
                                            <div class="wv-form-field__element" bis_skin_checked="1">
                                                <div class="" bis_skin_checked="1"><input
                                                        class="wv-input fs-exclude wv-input--medium fs-exclude"
                                                        type="text" autocapitalize="default" autocorrect="ON"
                                                        value=""><span class="wv-input__message"></span></div>
                                                <div class="wv-form-field__hint" bis_skin_checked="1">Name of a business
                                                    or person.</div>
                                            </div>
                                        </div> -->
                                        <div class="wv-form-field fWzb5BNM_IHGhuRY18cm fs-exclude" bis_skin_checked="1">
                                            <label class="wv-form-field__label">
                                                <div class="wv-form-field__label__text" bis_skin_checked="1">Primary
                                                    contact</div>
                                            </label>
                                            <div class="wv-form-field__element" bis_skin_checked="1">
                                                <div class="wv-form--floating-label" bis_skin_checked="1">
                                                    <div class="wv-box--green wv-box _dv_uj9Cl5yCrg3bgHEF"
                                                        bis_skin_checked="1">
                                                        <div class="wv-box__content" bis_skin_checked="1">
                                                            <div class="wv-form-field is-floating NLOO37CHI0uWt8c94sgX fs-exclude"
                                                                bis_skin_checked="1">
                                                                <div class="wv-form-field__wrapper"
                                                                    bis_skin_checked="1"><label
                                                                        class="wv-form-field__label">
                                                                        <div class="wv-form-field__label__text"
                                                                            bis_skin_checked="1">First name</div>
                                                                    </label>
                                                                    <div class="wv-form-field__element"
                                                                        bis_skin_checked="1">
                                                                        <div class="" bis_skin_checked="1"><input
                                                                                class="wv-input fs-exclude wv-input--medium fs-exclude"
                                                                                type="text" autocapitalize="default"
                                                                                autocorrect="ON" value=""><span
                                                                                class="wv-input__message"></span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="wv-form-field is-floating NLOO37CHI0uWt8c94sgX fs-exclude"
                                                                ...
                                                                <div class="wv-form-field__wrapper"
                                                                    bis_skin_checked="1"><label
                                                                        class="wv-form-field__label">
                                                                        <div class="wv-form-field__label__text"
                                                                            bis_skin_checked="1">Last name</div>
                                                                    </label>
                                                                    <div class="wv-form-field__element"
                                                                        bis_skin_checked="1">
                                                                        <div class="" bis_skin_checked="1"><input
                                                            ...
                                                            <div class="K6Vn3Yn0bjEzdgh4cUX0" bis_skin_checked="1">
                                                                <div class="wv-form-field is-floating W_ATJEefDGbul5kkA4TM fs-exclude"
                                                                    bis_skin_checked="1">
                                                                    <div class="wv-form-field__wrapper"
                                                                        bis_skin_checked="1"><label
                                                                            class="wv-form-field__label">
                                                                            <div class="wv-form-field__label__text"
                                                                                bis_skin_checked="1">Social Security
                                                                                Number</div>
                                                                        </label>
                                                                        <div class="wv-form-field__element"
                                                                            bis_skin_checked="1">
                                ...
                                <div class="wv-modal wv-modal--close" bis_skin_checked="1">
                                    <div class="wv-modal__window" bis_skin_checked="1">
                                        <div role="dialog" class="wv-modal__content" aria-modal="false"
                                            ...
                                            <div class="wv-modal__header" bis_skin_checked="1">
                                                <h1 class="wv-modal__header__title" id="wv-modal__header__title_id">Are
                                                    you sure you want to remove your customer's email?</h1><button
                                                    class="wv-close--large" aria-label="close dialog"></button>
                                            </div>
                                            <div class="wv-modal__content__scroll-area" bis_skin_checked="1">
                                                <div class="wv-modal__body" bis_skin_checked="1">
                                                    <p class="wv-text wv-text--body fs-exclude wv-text--inline">Any
                                                        scheduled reminders cannot be sent to this customer without
                                                        email address.</p>
                                                </div>
                                                <div class="wv-modal__footer" bis_skin_checked="1">
                                                    <div class="wv-button-wrapper" role="group" bis_skin_checked="1">
                                                        <button class="wv-button--secondary fs-exclude">No, restore
                                                            email</button><button
                                                            class="wv-button--primary fs-exclude">Yes, remove
                                                            email</button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="wv-divider" bis_skin_checked="1"></div>
                                <div class="wv-form--horizontal" bis_skin_checked="1">
                                    <fieldset class="wv-form-fieldset jLLHJFYpzHjgmubdkChY">
                                        <legend class="wv-form-legend">Billing</legend>

                                        <div class="fs-exclude" bis_skin_checked="1">
                                            <div class="wv-form-fieldset wv-form-fieldset--address wv-form-fieldset--address--universal"
                                                bis_skin_checked="1">
                                                <label class="wv-form-field__label"> 
                                                     </label>
                                                <div class="wv-form-field__element wv-input--medium"
                                                    bis_skin_checked="1"><input
                                                        class="wv-input fs-exclude wv-input--street"
                                                        placeholder="Address" type="text" autocapitalize="default"
                                                        autocorrect="ON" value=""><input
                                                        class="wv-input fs-exclude wv-input--unit"
                                                        placeholder="Address 2" type="text" autocapitalize="default"
                                                        autocorrect="ON" value="">
                                                    <div class="wv-select wv-select--country fs-exclude zindex"
                                                        tabindex="0">
                                                        <div class="wv-select__input wv-select__toggle"><span
                                                                class="wv-select__label">Country</span>
                                                        ...
                                                        <div class="wv-select__menu">
                                                            <div class="wv-select__search-container"><span
                                                                    class="wv-prefixed-input wv-prefixed-input--fluid"><span
                                                                        class="wv-prefixed-input__prefix"><svg
                                                                            class="wv-svg-icon"
                                                                        ...
                                                                        value=""></span></div>
                                                            <ul class="wv-select__menu__options"
                                                                style="max-height: 200px;">
                                                                <div class="wv-select__menu__title">Country</div>
                                                                <div class="wv-select__menu__option is-group-option">
                                                                    <span>Canada</span>
                                                                </div>
                                                                <div class="wv-select__menu__option is-group-option">
                                                                ...
                                                                <div
                                                                    class="wv-select__menu__option is-active is-group-option">
                                                                ...
                                                                <div class="wv-select__menu__option is-group-option">
                                                                    <span>Saint Helena, Ascension and Tristan da
                                                                        Cunha</span>
                                                                </div>
                                                                <div class="wv-select__menu__option is-group-option">
                                                                ...
                                                                <div class="wv-select__menu__option is-group-option">
                                                                    <span>South Georgia and the South Sandwich
                                                                        Islands</span>
                                                                </div>
                                                                <div class="wv-select__menu__option is-group-option">
                                                    ...
                                                    <div class="wv-select wv-select--state proov fs-exclude"
                                                        tabindex="0">
                                                        <div class="wv-select__input wv-select__toggle"><span
                                                                class="wv-select__label">Province, State, or
                                                                Region</span>
                                                            <div class="wv-select__input__icon"><svg class="wv-svg-icon"
                                                                    aria-labelledby="open-menu-title"
                                                                    aria-hidden="false">
                                                        ...
                                                        <div class="wv-select__menu">
                                                            <div class="wv-select__search-container"><span
                                                                    class="wv-prefixed-input wv-prefixed-input--fluid"><span
                                                                        ...
                                                                        value=""></span></div>
                                                            <ul class="wv-select__menu__options">
                                                                <div class="wv-select__menu__option"><span>Alaska</span>
                                                                </div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Alabama</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Arkansas</span></div>
                                                                <div class="wv-select__menu__option">
                                                                ...
                                                                <div class="wv-select__menu__option">
                                                                    <span>Connecticut</span></div>
                                                                <div class="wv-select__menu__option"><span>District of
                                                                        Columbia</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Delaware</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Florida</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Georgia</span></div>
                                                                <div class="wv-select__menu__option"><span>Hawaii</span>
                                                                </div>
                                                                <div class="wv-select__menu__option"><span>Iowa</span>
                                                                </div>
                                                                <div class="wv-select__menu__option"><span>Idaho</span>
                                                                </div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Illinois</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Indiana</span></div>
                                                                <div class="wv-select__menu__option"><span>Kansas</span>
                                                                </div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Kentucky</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Louisiana</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Massachusetts</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Maryland</span></div>
                                                                <div class="wv-select__menu__option is-active">
                                                                    <span>Maine</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Michigan</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Minnesota</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Missouri</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Mississippi</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Montana</span></div>
                                                                <div class="wv-select__menu__option"><span>North
                                                                        Carolina</span></div>
                                                                <div class="wv-select__menu__option"><span>North
                                                                        Dakota</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Nebraska</span></div>
                                                                <div class="wv-select__menu__option"><span>New
                                                                        Hampshire</span></div>
                                                                <div class="wv-select__menu__option"><span>New
                                                                        Jersey</span></div>
                                                                <div class="wv-select__menu__option"><span>New
                                                                        Mexico</span></div>
                                                                <div class="wv-select__menu__option"><span>Nevada</span>
                                                                </div>
                                                                <div class="wv-select__menu__option"><span>New
                                                                        York</span></div>
                                                                <div class="wv-select__menu__option"><span>Ohio</span>
                                                                </div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Oklahoma</span></div>
                                                                <div class="wv-select__menu__option"><span>Oregon</span>
                                                                </div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Pennsylvania</span></div>
                                                                <div class="wv-select__menu__option"><span>Rhode
                                                                        Island</span></div>
                                                                <div class="wv-select__menu__option"><span>South
                                                                        Carolina</span></div>
                                                                <div class="wv-select__menu__option"><span>South
                                                                        Dakota</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Tennessee</span></div>
                                                                <div class="wv-select__menu__option"><span>Texas</span>
                                                                </div>
                                                                <div class="wv-select__menu__option"><span>Utah</span>
                                                                </div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Virginia</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Vermont</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Washington</span></div>
                                                                <div class="wv-select__menu__option">
                                                                    <span>Wisconsin</span></div>
                                                                <div class="wv-select__menu__option"><span>West
                                                                        Virginia</span></div>
                                                                <div class="wv-select__menu__option">
                                                    ...
                                                    <input class="wv-input fs-exclude wv-input--city" placeholder="City"
                                                        type="text" autocapitalize="default" autocorrect="ON"
                                                        value=""><input class="wv-input fs-exclude wv-input--zip"
                                                        placeholder="Postal" type="text" autocapitalize="default"
                                                        autocorrect="ON" value="">
                                                    <div bis_skin_checked="1"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="wv-form-field fs-exclude" bis_skin_checked="1"><label
                                                class="wv-form-field__label--blank">
                                                <div class="wv-form-field__label__text" bis_skin_checked="1"></div>
                                            </label>
                                            <!-- <div class="wv-form-field__element" bis_skin_checked="1"><a
                                                    class="wv-text--link fs-exclude">Clear address</a></div>
                                        </div> -->
                                    </fieldset>
                                </div>
                                ...
                                <div class="wv-form--horizontal JnC23BolYXGvimZNnLgc" bis_skin_checked="1">
                                    <fieldset class="wv-form-fieldset">
                                        <legend class="wv-form-legend">Direct Deposite Payment Bank Details:</legend>
                                        <!-- <div class="wv-form-field is-required fs-exclude" bis_skin_checked="1"><label
                                                class="wv-form-field__label">
                                                <div class="wv-form-field__label__text" bis_skin_checked="1">Customer
                                                </div>
                                        ...
                                        <div class="wv-form-field fWzb5BNM_IHGhuRY18cm fs-exclude" bis_skin_checked="1">
                                            ...
                                            <div class="wv-form-field__element" bis_skin_checked="1">
                                                <div class="wv-form--floating-label" bis_skin_checked="1">
                                                    <div class="wv-box--green wv-box _dv_uj9Cl5yCrg3bgHEF" bis_skin_checked="1">
                                                        <div class="wv-box__content" bis_skin_checked="1">
                                                            <div class="wv-form-field is-floating NLOO37CHI0uWt8c94sgX fs-exclude" bis_skin_checked="1">
                                                                <div class="wv-form-field__wrapper" bis_skin_checked="1"><label class="wv-form-field__label">
                                                                        <div class="wv-form-field__label__text" bis_skin_checked="1">Bank name</div>
                                                                    </label>
                                                                    <div class="wv-form-field__element" bis_skin_checked="1">
                                                                        <div class="" bis_skin_checked="1"><input class="wv-input fs-exclude wv-input--medium fs-exclude" type="text" autocapitalize="default" autocorrect="ON" value=""><span class="wv-input__message"></span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="wv-form-field is-floating NLOO37CHI0uWt8c94sgX fs-exclude" bis_skin_checked="1">
                                                                <div class="wv-form-field__wrapper" bis_skin_checked="1"><label class="wv-form-field__label">
                                                                        <div class="wv-form-field__label__text" bis_skin_checked="1">Account Number</div>
                                                                    </label>
                                                                    <div class="wv-form-field__element" bis_skin_checked="1">
                                                                        <div class="" bis_skin_checked="1"><input class="wv-input fs-exclude wv-input--medium fs-exclude" type="text" autocapitalize="default" autocorrect="ON" value=""><span class="wv-input__message"></span></div>
                                                                    </div>
                                                            ...
                                                            <div class="wv-form-field is-floating NLOO37CHI0uWt8c94sgX fs-exclude" bis_skin_checked="1">
                                                                <div class="wv-form-field__wrapper" bis_skin_checked="1"><label class="wv-form-field__label">
                                                                        <div class="wv-form-field__label__text" bis_skin_checked="1">Routing Number</div>
                                                                    </label>
                                                                    <div class="wv-form-field__element" bis_skin_checked="1">
                                                                        <div class="" bis_skin_checked="1"><input class="wv-input fs-exclude wv-input--medium fs-exclude" type="text" autocapitalize="default" autocorrect="ON" value=""><span class="wv-input__message"></span></div>
                                                                    </div>
                                ...
                                <div class="wv-form--horizontal" bis_skin_checked="1">
                                    <div class="wv-form-field fs-exclude" bis_skin_checked="1"><label
                                        ...
                                        <div class="wv-form-field__element" bis_skin_checked="1"><button
                                                class="wv-button--secondary fs-exclude qx4zTqj9tVqM1yRSJy3t">Cancel</button><button
                                                class="wv-button--submit fs-exclude qx4zTqj9tVqM1yRSJy3t">Save</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    $('.zindex').on('click', function() {
        if ($('.zindex').hasClass('is-open')) {
            $('.zindex').removeClass('is-open');
        } else {
            $('.zindex').addClass('is-open');
        }
    });
    $('.proov').on('click', function() {
        if ($('.proov').hasClass('is-open')) {
            $('.proov').removeClass('is-open');
        } else {
            $('.proov').addClass('is-open');
        }
    });
    </script>
