...
<head>
    ...
    <title>Wave • Derman • Products &amp; Services</title>
    ...
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="float/main"
        src="https://d3pgswpng8id0l.cloudfront.net/sitestatic/js/built/float-main-96e6b962561451ca9658ad7184121194.js">
    </script>
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="main"
        src="https://d3pgswpng8id0l.cloudfront.net/sitestatic/js/built/main-a8d0313f8b6598e1b47c85fcc3ba0465.js">
    </script>
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="validate_delete"
        src="https://d3pgswpng8id0l.cloudfront.net/sitestatic/js/built/validate_delete-d86ec35457e8826f74799eac52f6eb5b.js">
    </script>
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="object_exists"
        src="https://d3pgswpng8id0l.cloudfront.net/sitestatic/js/built/object_exists-070db9feb429d9ea4cc1a013542e542f.js">
    </script>
    <style type="text/css" id="qual_style-zba"></style>
    <style type="text/css" id="qual_style-zc8"></style>
</head>

<body class="accounting-settings-section wv-shim--modal wv-shim--notification wide"
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="wv-header--page">
                                            ...
                                            <div class="wv-header__actions">
                                                <a class="wv-button--primary"
                                                    href="/products/17268606/add/?from=buying">
                                        ...
                                        <table class="wv-table">
                                            <thead class="wv-table__header">
                                                <tr class="wv-table__row">
                                                    <th class="wv-table__cell">Name</th>
                                                    <th class="wv-table__cell--amount">Price</th>
                                                    <th class="wv-table__cell--actions">Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody class="wv-table__body">

                                                <tr class="wv-table__row">
                                                    <td class="wv-table__cell text-break product_name">
                                                        Fuel

                                                        <p class="wv-table__cell--nested"></p>
                                                    </td>
                                                    <td class="wv-table__cell--amount">
                                                        $0.00
                                                        <p class="wv-table__cell--nested"></p>
                                                    </td>
                                                    <td class="wv-table__cell--actions">
                                                        <a href="/products/17268606/edit/91768465/?from=buying"
                                                            class="wv-tooltip__target wv-table__action js-edit-item"
                                                            rel="product">
                                                            <span class="wv-tooltip--top">Edit</span>
                                                            <svg class="wv-svg-icon">
                                                                <use href="#edit" xlink:href="#edit"></use>
                                                            </svg>
                                                        </a>

                                                        <a href="javascript:void(0);"
                                                            datahref="/products/17268606/91768465/?from=buying"
                                                            class="wv-tooltip__target wv-table__action wv-table__action--danger js-del-item"
                                                            rel="product">
                                                            <span class="wv-tooltip--top">Delete</span>
                                                            <svg class="wv-svg-icon">
                                                                <use href="#delete" xlink:href="#delete"></use>
                                                            </svg>
                                                        </a>
                                                ...
                                                <tr class="wv-table__row">
                                                    ...
                                                    <td class="wv-table__cell--actions">
                                                        <a href="/products/17268606/edit/91768245/?from=buying"
                                                            class="wv-tooltip__target wv-table__action js-edit-item"
                                                            rel="product">
                                                            <span class="wv-tooltip--top">Edit</span>
                                                            <svg class="wv-svg-icon">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            datahref="/products/17268606/91768245/?from=buying"
                                                            class="wv-tooltip__target wv-table__action wv-table__action--danger js-del-item"
                                                            rel="product">
                                                            <span class="wv-tooltip--top">Delete</span>
                                                            <svg class="wv-svg-icon">
                                                ...
                                                <tr class="wv-table__row">
                                                    ...
                                                    <td class="wv-table__cell--actions">
                                                        <a href="/products/17268606/edit/91768381/?from=buying"
                                                            class="wv-tooltip__target wv-table__action js-edit-item"
                                                            rel="product">
                                                            <span class="wv-tooltip--top">Edit</span>
                                                            <svg class="wv-svg-icon">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            datahref="/products/17268606/91768381/?from=buying"
                                                            class="wv-tooltip__target wv-table__action wv-table__action--danger js-del-item"
                                                            rel="product">
                                                            <span class="wv-tooltip--top">Delete</span>
                                                            <svg class="wv-svg-icon">
    ...
    <div class="wv-takeover session-warning" id="inactivity-modal-47936" role="dialog" aria-hidden="false">
    ...
    <div></div><iframe id="qualaroo_dnt_frame" src="//dntcl.qualaroo.com/frame.html" title="Qualaroo iframe for nudge"
