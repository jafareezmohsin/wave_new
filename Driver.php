...
<head>
    ...
    <title>Wave • Derman • Vendors</title>
...
<body class="wv-shim--modal wv-shim--notification settings-vendors-list-page wide"
            ...
            <div class="wv-frame__content">
                ...
                <div class="wv-frame__content__body">
                    ...
                    <div class="wv-frame__content__body__main">
                        <div
                            class="wv-frame__content__body__main__wrapper wv-frame__content__body__main__wrapper--fixed">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="wv-header--page">
                                            <div class="wv-header__title">
                                                <h1 class="wv-heading--title"> Vendors</h1>
                                            </div>


                                            <div class="wv-header__actions">
                                                <div class="wv-dropdown">
                                                    <button class="wv-dropdown__toggle wv-button" tabindex="1">Import
                                                        from... <svg class="wv-svg-icon">
                                                            <use xlink:href="#open-menu" href="#open-menu"></use>
                                                        </svg></button>
                                                    <ul class="wv-dropdown__menu--right">
                                                        <li class="wv-dropdown__menu__item">
                                                            <a href="/contacts-import/17268606/csv/vendor/"
                                                                class="wv-dropdown__menu__link">CSV</a>
                                                        </li>
                                                        <li class="wv-dropdown__menu__item">
                                                            <a href="/contacts-import/17268606/google-contacts/vendor/"
                                                                class="wv-dropdown__menu__link">Google Contacts</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <a class="wv-button--primary" href="/clients/vendor/add/17268606/">
                                                    Add a vendor
                                                </a>
                                            </div>
                                        ...
                                        <table class="vendors wv-table">
                                            <thead class="wv-table__header">
                                                <tr class="wv-table__row">

                                                    <th class="vendors-header-type wv-table__cell">Type</th>

                                                    <th class="wv-table__cell">Name</th>
                                                    <th class="wv-table__cell">Email</th>

                                                    <th class="wv-table__cell">Direct deposit</th>
                                            ...
                                            <tbody class="wv-table__body">
                                                ...
                                                <tr class="wv-table__row">
                                                    ...
                                                    <td class="wv-table__cell">
                                                        ...
                                                        <span class="vendor-type-badge wv-badge">Vendor</span>

                                                    </td>

                                                    <td class="wv-table__cell text-break vendor_name fs-hide">
                                                        Integrea

                                                    </td>
                                                    <td class="wv-table__cell fs-hide"></td>
                                                    <td class="wv-table__cell fs-hide">


                                                        <p class="wv-text--fine-print">Not available</p>


                                                    </td>

                                                    <td class="wv-table__cell--actions vendor-actions">
                                                        <a href="/bills/17268606/add/9947801/"
                                                            class="wv-table__action primary-action">
                                                            <span class="wv-text--link">Create bill</span>
                                                        </a>

                                                        <div class="wv-dropdown">
                                                            <button
                                                                class="wv-dropdown__toggle wv-button--small wv-button--secondary"
                                                                tabindex="2">
                                                                <svg class="wv-svg-icon">
                                                                    <use xlink:href="#open-menu" href="#open-menu">
                                                                    </use>
                                                                </svg>
                                                            </button>
                                                            ...
                                                            <ul class="wv-dropdown__menu--right">
                                                                ...
                                                                <li class="wv-dropdown__menu__item">
                                                                    <a href="/clients/vendor/edit/9947801/17268606/"
                                                                        class="wv-dropdown__menu__link js-edit-item"
                                                                        rel="vendor">
                                                                        Edit
                                                                    </a>
                                                                </li>
                                                                ...
                                                                <li class="wv-dropdown__menu__item">
                                                                    <a href="/bills/17268606/add/9947801/"
                                                                        class="wv-dropdown__menu__link" rel="vendor">
                                                                        Create bill
                                                                    </a>
                                                                </li>

                                                                <li class="wv-dropdown__menu__divider"></li>
                                                                <li class="wv-dropdown__menu__item">
                                                                    <a href="javascript:void(0);"
                                                                        datahref="/clients/vendor/17268606/9947801/"
                                                                        class="wv-dropdown__menu__link js-del-item"
                                                                        rel="vendor">
                                                                        Delete
                                                                    </a>
                                                                </li>
                                                ...
                                                <tr class="wv-table__row">
                                                    ...
                                                    <td class="wv-table__cell fs-hide">MLukes932@gmail.com</td>
                                                    <td class="wv-table__cell fs-hide">
                                                    ...
                                                    <td class="wv-table__cell--actions vendor-actions">
                                                        <a href="/bills/17268606/add/10011458/"
                                                            class="wv-table__action primary-action">
                                                            <span class="wv-text--link">Create bill</span>
                                                        </a>
                                                        ...
                                                        <div class="wv-dropdown">
                                                            ...
                                                            <ul class="wv-dropdown__menu--right">
                                                                ...
                                                                <li class="wv-dropdown__menu__item">
                                                                    <a href="/clients/vendor/edit/10011458/17268606/"
                                                                        class="wv-dropdown__menu__link js-edit-item"
                                                                        rel="vendor">
                                                                        Edit
                                                                    </a>
                                                                ...
                                                                <li class="wv-dropdown__menu__item">
                                                                    <a href="javascript:void(0);"
                                                                        datahref="/clients/vendor/17268606/10011458/"
                                                                        class="wv-dropdown__menu__link js-del-item"
                                                                        rel="vendor">
                                                                        Delete
                                                                    </a>
    ...
    <div class="wv-takeover session-warning" id="inactivity-modal-130257" role="dialog" aria-hidden="false">
        <div class="wv-takeover__content">
            ...
            <div class="wv-takeover__actions">
                <button class="wv-button--secondary modal-signout" tabindex="4">Sign Out</button>
                <button class="wv-button--primary back" tabindex="5">Back to Wave</button>
            </div>
        </div>
    </div>
